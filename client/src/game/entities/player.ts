...
export default class Player {
    ...
    constructor(scene :Phaser.Scene, room: any, player: { x: any; y: any; onChange?: (arg0: () => void) => void; }) {
        this.scene = scene;
    ...
    add() {
        ...
        this.scene.input.on("pointerdown", (event: { worldX: string; worldY: string; }) => {
    ...
    updatePlayer() {
        ...
        this.scene.physics.world.collide(this.scene.jigs.localPlayer.entity, this.scene.Walls.walls);
